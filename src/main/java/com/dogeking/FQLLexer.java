...
public class FQLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"KW_JAVA", "KW_JSON", "KW_JOB", "KW_JOBS", "KW_JSON_EXECUTION_PLAN", 
			...
			"SQUOTA_STRING", "BQUOTA_STRING", "DOT", "LS_BRACKET", "RS_BRACKET", 
			"LR_BRACKET", "RR_BRACKET", "LB_BRACKET", "RB_BRACKET", "COMMA", "SEMICOLON", 
